...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'estadisticas',
        name: 'TorneoEstadisticas',
        component: () => import('@/views/admin-torneo/EstadisticasView.vue'),
        meta: { title: 'Estadísticas', requiereRol: ['admin_torneo'] },
      },
      {
        path: 'solicitudes',
      ...
      {
        path: 'comunicados',
        name: 'TorneoComunicados',
        component: () => import('@/views/admin-torneo/ComunicadosView.vue'),
        meta: { title: 'Comunicados', requiereRol: ['admin_torneo'] },
      },
      {
        path: 'tesoreria',
        name: 'TorneoTesoreria',
        component: () => import('@/views/admin-torneo/TesoreriaView.vue'),
        meta: { title: 'Tesorería', requiereRol: ['admin_torneo'] },
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'SedeTesoreria',
        component: () => import('@/views/admin-torneo/TesoreriaView.vue'),
        meta: { title: 'Tesorería', requiereRol: ['admin_sede'] },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'comunicados',
        name: 'CapitanComunicados',
        component: () => import('@/views/capitan/ComunicadosView.vue'),
        meta: { title: 'Comunicados', requiereRol: ['jugador'] },
      },
      {
        path: 'partidos/:id',
